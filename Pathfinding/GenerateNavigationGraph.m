...
if nargin > 3
    ...
    if size(travSharedSides, 1) > 0
        ...
        waypoints = [waypoints;
            [points(travSharedSides(:,1),1) + points(travSharedSides(:,2),1), ...
            points(travSharedSides(:,1),2) + points(travSharedSides(:,2),2), ...
            points(travSharedSides(:,1),3) + points(travSharedSides(:,2),3)] / 2 ];
        waypointTriIndices = [waypointTriIndices; ...
            travSharedSides(:,3), travSharedSides(:,4)];
        ...
        if nargin > 4
            ...
            waypoints = [waypoints;
                [points(travSharedSides(longIndices,1),1) * 3 ...
                    + points(travSharedSides(longIndices,2),1), ...
                points(travSharedSides(longIndices,1),2) * 3 ...
                    + points(travSharedSides(longIndices,2),2), ...
                points(travSharedSides(longIndices,1),3) * 3 ...
                    + points(travSharedSides(longIndices,2),3)] / 4 ];
            waypointTriIndices = [waypointTriIndices; ...
                travSharedSides(longIndices,3), ...
                travSharedSides(longIndices,4)];
            waypoints = [waypoints;
                [points(travSharedSides(longIndices,1),1) ...
                    + points(travSharedSides(longIndices,2),1) * 3, ...
                points(travSharedSides(longIndices,1),2) ...
                    + points(travSharedSides(longIndices,2),2) * 3, ...
                points(travSharedSides(longIndices,1),3) ...
                    + points(travSharedSides(longIndices,2),3) * 3] / 4 ];
            waypointTriIndices = [waypointTriIndices; ...
                travSharedSides(longIndices,3), ...
                travSharedSides(longIndices,4)];
        end
